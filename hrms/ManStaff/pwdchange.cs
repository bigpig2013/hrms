...
namespace hrms.ManStaff
{
    public partial class pwdchange : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string sqllg = "select username,password from ygdl where id = '" + textBox1.Text + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlConnection conn = new SqlConnection(sqldb);
                conn.Open();
                string strSql = "update ygdl set password = @password where id = '" + textBox1.Text + "'";
                SqlCommand cmd = new SqlCommand(strSql, conn);
                SqlParameter[] paras = new SqlParameter[1];
                paras[0] = new SqlParameter("@password", SqlDbType.NVarChar);
